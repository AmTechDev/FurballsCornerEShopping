...
const Timeline = props => {
    return (
        ...
        <div className="centered">
            ...
            <p>We Offer Pet necessities that keep you coming back, so<a href="#ShopNow"><div class="hero-btn mt-5">
                    <button class="btn custom-btn btn-info mr-4">Shop Now!</button>
